...
from app.bot.handlers.redeem import router as redeem_router
from app.bot.handlers.ranking import router as ranking_router
from app.bot.handlers.winners import router as winners_router
