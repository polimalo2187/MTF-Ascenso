...
async def admin_open_claim(message: Message):
    ...
    # Mostramos acciones (aprobar/rechazar).
    # La foto (file_id) está guardada y se podrá usar luego si quieres reenviarla aquí,
    # pero en V1 solo operamos con el ID.
    await message.answer(
...
async def admin_approve(callback: CallbackQuery):
    ...
    # Volvemos a pendientes primera página para seguir trabajando
    await callback.message.edit_text(
