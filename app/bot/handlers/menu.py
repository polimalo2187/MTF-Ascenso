...
async def menu_router(callback: CallbackQuery):
    ...
    if action == "tasks":
        await callback.message.edit_text(
            "✅ <b>Tareas</b>\n\n"
            "Muy pronto activaremos el Centro de Tareas.\n"
            "Por ahora puedes revisar tus puntos en el menú.",
    ...
    if action == "redeem":
        await callback.message.edit_text(
            ...
            "Aquí verás los botones de canje cuando activemos el panel de admin.",
            reply_markup=main_menu_kb(),
        )
        await callback.answer()
        return
